            ...
            <Grid item sx={{}} xs>
                ...
                <Grid container spacing={0} sx={{}}>
                  ...
                  <Grid item xs={12} sx={{marginBlockEnd: '3vh'}}>
                    <Box>
                      <Typography variant='h4' component='div' sx={{width: '100%', textAlign: 'center', fontSize: '4rem', fontWeight: 'bold'}}  className='gradient-text-subcategories'> Our Mission</Typography>
                      <Typography variant='body1' component='div' sx={{width: '100%', textAlign: 'center', marginBlock: '1vh 3vh'}} >
                  ...
                  <Grid item xs={12} sx={{}}>
                    <Box sx={{paddingInline: {xs:'3vw', md:'17.5vw'}, fontSize: {xs:'1.5rem',}}}>
                      <Typography variant='h4' component='div' sx={{width: '100%', textAlign: 'center', fontSize: '4rem', fontWeight: 'bold'}} className='gradient-text-subcategories'> Our Story</Typography>
                      <Typography variant='body1' component='div' sx={{width: '100%', textAlign: 'left', marginBlock: '3vh'}}>
                ...
                <Grid item xs>
                  <Typography className='gradient-text-subcategories' variant='h4' component='div' sx={{ width: '100%', textAlign: 'center'}}>
                    How We Can Help?
                  </Typography>
                </Grid>
                <Grid item xs className='justify-center'>
                  <Box  sx={{paddingInline: {xs: '3vw', md:'17.5vw'}, fontSize: {xs:'1.5rem', }}} className="text-center">
                      <Typography variant='body1'component='div' sx={{marginBlockEnd: '3vh'}}>
                      ...
                      <Typography variant='body1'component='div' sx={{marginBlockEnd: '3vh'}}>
                        We meticulously curate articles and resources on mindset and resilience, providing you with practical insights and strategies to enhance personal growth. Our shop features handpicked products directly sourced from the articles on our site, offering you convenient access to tools that can support your journey towards a fulfilling lifestyle.
                          ...
                          <span className='we-can-help-span' style={{}} >Goal Tracking and Reminder System</span>
                      <Typography variant='body1'component='div' sx={{marginBlockEnd: '3vh'}}> We understand that setting and achieving goals can be challenging. That&gt;s why we&gt;re developing a cutting-edge tracking system and reminder tool to help you stay on track once you&gt;ve defined your objectives. This innovative feature will provide gentle nudges, ensuring you maintain focus and motivation on your path towards success. As you progress, we&gt;ll also introduce a reward system to celebrate your achievements and keep you inspired along the way.
                      </Typography>
                          <span className='we-can-help-span' style={{}} >Positive Community and Support</span>
                      <Typography variant='body1'component='div' sx={{marginBlockEnd: '3vh'}}> At Pearl Box, we believe that a positive environment is essential for personal growth. Our community is filled with like-minded individuals who are passionate about cultivating a lifestyle worth living. By joining our community, you&gt;ll experience the power of connection, support, and encouragement from individuals who share your aspirations. Together, we reinforce positivity and create an uplifting atmosphere that fuels personal transformation.
                      </Typography>
                          <span className='we-can-help-span' style={{}} >Education and Technological Tools</span>
                      <Typography variant='body1'component='div' sx={{marginBlockEnd: '3vh'}}> We are dedicated to empowering you through education and technology. Our courses, carefully designed and led by industry experts, cover a range of topics related to personal growth and well-being. Additionally, we provide a comprehensive library of information and research, ensuring that you have access to a wealth of knowledge to support your journey.
                      </Typography>
                          <span className='we-can-help-span mr-5' style={{}}  >Enhancing Quality of Life</span>
                      <Typography variant='body1'component='div' sx={{marginBlockEnd: '3vh'}}> At Pearl Box, we go beyond theory and actively seek ways to enhance the quality of life in all aspects. Our commitment to providing high-quality information and utilizing innovative tech tools ensures that we empower you to lead a more fulfilling life. From mental and physical well-being to personal development and self-discovery, we strive to be your trusted partner in every step of your journey.
