...
import { blue, deepPurple, orange, yellow } from '@mui/material/colors';
...
const coreValues = ['Passion', 'Purpose', 'Innovation', 'Growth', 'Integrity', 'Impact', 'Simplicity', 'Balance', ];
  ...
  return (
    <div style={{width: '100%', marginBlockStart: '10vh'}}>
      <Typography variant='h2' component='div' sx={{width:'100%', textAlign:'center', marginBlock: '2vh', color: deepPurple[100], fontSize: {xs:'4rem',md:'6rem'}, fontWeight: 'bold'}}>
        Pearl Box
      </Typography>
      <Box sx={{}}>
        <Grid container sx={{color: deepPurple[100],}} spacing={0}>
