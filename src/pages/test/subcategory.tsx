...
const Subcategory = () => {
    ...
    const handleCreate = () => {
        ...
        try {
            ...
            axios.post('/api/blog/subcategory/create', category)
    ...
    return (
        ...
        <Box className='min-h-screen' sx={{bgcolor: grey[200]}}>
            <form onSubmit={handleCreate}>

                <div>

                    <TextField variant='outlined' value={name} sx={{}} className='' label='Subcategory Name' onChange={(e)=>setName(e.target.value)} />
